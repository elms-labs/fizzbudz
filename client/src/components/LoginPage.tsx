...
<div className='bg-slate-600 bg-opacity-50 rounded-lg mx-auto text-white px-10 py-16 max-w-xl grid gap-8 ml-[50px] shadow-2xl justify-items-center' id='gettingStartedWrapper'>
